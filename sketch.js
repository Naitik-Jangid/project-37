...
Apply Kangaroo_running and kangaroo_collided animation to it.
 Scale the kangaroo if required.
Set the collider of the kangaroo as a circle
the radius of the collider as 300
*/
...
// Set the x-Position of the kangaroo according to the camera    
  if (gameState===PLAY){
